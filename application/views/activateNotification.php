...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	<tr>
		<td style="padding-bottom: 40px; font-family: 'Open Sans', 'Roboto', 'Segoe UI', Arial, sans-serif; text-align: center;" class="text-xs-center">
			<h1 style="margin: 0 0 30px; font-size: 24px; line-height: 40px; color: #4b4b4b; font-weight: 700; white-space: normal; word-break: break-word;">You are one step away from signing up to Onlyperks</h1>
			<p style="margin: 0; font-size: 14px; line-height: 24px; color: #696969; font-weight: 300;">You are almost there, all you have to do now is click on the following button to activate your account and start enjoying our collaboration modules:</p>
		</td>
	</tr>
	<!-- 1 Column Text : END -->
	<!-- Button : BEGIN -->
						...
						<table border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td align="center" style="border-radius: 6px; font-family: 'Open Sans', 'Roboto', 'Segoe UI', Arial, sans-serif;" bgcolor="#ff7a06" valign="middle">
									<a href="<?php echo $url; ?>" target="_blank" style="font-size: 14px; line-height: 24px; font-weight: bold; color: #ffffff !important; text-decoration: none; border-radius: 6px; padding: 10px; border: 2px solid #ff7a06; display: inline-block; white-space: normal; word-break: break-word;">Activate account</a>
								</td>
							</tr>
						</table>
					</td>
